...
minetest.register_craftitem("bbq:stuffed_mushroom_raw", {
	...
	groups = {food_stuffed_mushroom_raw = 1},
})
...
minetest.register_craftitem("bbq:leg_lamb_raw", {
	...
	groups = {food = 1, food_meat_raw = 1, food_leg_lamb_raw = 1},
...
minetest.register_craftitem("bbq:ham_raw", {
	...
	groups = {food = 1, food_meat_raw = 1, food_ham_raw = 1},
	on_use = minetest.item_eat(9),
})
...
minetest.register_craftitem("bbq:bbq_chicken_raw", {
	...
	groups = {food = 1, food_meat_raw = 1, food_bbq_chicken_raw = 1},
...
minetest.register_craftitem("bbq:corned_beef_raw", {
	...
	groups = {food = 1, food_meat_raw = 1, food_corned_beef_raw = 1},
	on_use = minetest.item_eat(10),
})
...
minetest.register_craftitem("bbq:brisket_raw", {
	...
	groups = {food = 1, food_meat_raw = 1, food_brisket_raw = 1},
	on_use = minetest.item_eat(9),
})
...
minetest.register_craftitem("bbq:bbq_beef_ribs_raw", {
	...
	groups = {food = 1, food_meat_raw = 1, food_bbq_beef_ribs_raw = 1},
	on_use = minetest.item_eat(9),
})
...
minetest.register_craftitem("bbq:hot_wings_raw", {
	...
	groups = {food = 1, food_meat_raw = 1, food_hot_wings_raw = 1},
	on_use = minetest.item_eat(8),
})
...
minetest.register_craftitem("bbq:hamburger_patty_raw", {
	...
	groups = {food = 1, food_meat_raw = 1, food_hamburger_patty_raw = 1},
	on_use = minetest.item_eat(8),
})
...
minetest.register_craftitem("bbq:hotdog_raw", {
	...
	groups = {food = 1, food_meat_raw = 1, food_hotdog_raw = 1},
...
minetest.register_craftitem("bbq:pepper_steak_raw", {
	...
	groups = {food = 1, food_meat_raw = 1, food_pepper_steak_raw = 1},
	on_use = minetest.item_eat(10),
})
...
minetest.register_craftitem("bbq:london_broil_raw", {
	...
	groups = {food = 1, food_meat_raw = 1, food_london_broil_raw = 1},
	on_use = minetest.item_eat(7),
})
...
minetest.register_craftitem("bbq:stuffed_chop_raw", {
	...
	groups = {food_stuffed_chop_raw = 1},
})
